...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Asignación de características musicales para ambientación comercial} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Carlos Alberto Rivas Araque} \\[1cm]
        ...
        \textbf{Director:} Esp. Ing. Martín Moreyra (GatekeeperX)} \\[1cm]
        ...
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Ana Laura Diedrichs (FIUBA)} \\[2cm]
