...
El trabajo está en producción, clasifica las canciones que ingresan al sistema y sirve como base en el contexto de una empresa en crecimiento. 
...
\item La decisión de usar librerías como Librosa y PANNs inference y modelos como redes MLP y árboles, permitió no depender de licencias ni pagar costos por consultas a modelos de terceros, también facilitó el trabajo al no requerir de arquitecturas complejas.
...
\item Para la detección de público en vivo y habla en canciones, se requirió de limpieza de ruido por falsas etiquetas apoyada en un modelo preentrenado con el conjunto de datos AudioSet, aun usado por YouTube cuando aparece por ejemplo en los subtítulos un [Aplausos] o [Rapping].
...
Como ejemplos, el \textit{speechiness}, \textit{speechiness} y la predicción de \textit{liveness}: el modelo actual logra diferenciar una canción instrumental de una que no lo es, pero los valores en el medio no son claros. 
