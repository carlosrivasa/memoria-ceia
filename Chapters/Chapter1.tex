...
Esta sección define las metas del proyecto. Se presenta el objetivo general y los objetivos específicos, los pasos metodológicos necesarios para su cumplimiento y el conjunto de características musicales consideradas.
...
El detalle técnico, las definiciones formales y el modelado de cada característica como problema de clasificación o regresión se abordan en el transcurso de la presente memoria.
...
En el Capítulo 2 se presentan las herramientas de terceros y las tecnologías necesarias para el desarrollo del sistema. Se describe la fuente de datos principal, las técnicas para extraer representaciones numéricas del audio, los modelos de aprendizaje automático seleccionados y las tecnologías para el despliegue.

En el Capítulo 3 se detalla el desarrollo del trabajo. Se documenta la evaluación y selección de los conjuntos de datos. Se analizan las distribuciones de las variables objetivo y las estrategias de muestreo. Asimismo, se describen las técnicas de selección y reducción de variables de entrada para el uso de una arquitectura mixta. Luego, se explica el proceso de modelado y la búsqueda de hiperparámetros. Finalmente, se presentan los resultados generales de la iteración productiva y la arquitectura para el despliegue del sistema.

En el Capítulo 4 se presentan los resultados obtenidos. Se evalúa el desempeño de los distintos modelos entrenados y se justifica la selección final de los algoritmos para su paso a producción.

Finalmente, en el Capítulo 5 se exponen las conclusiones generales del proyecto, el cumplimiento de los objetivos propuestos y las posibles líneas de trabajo futuro para mejorar el sistema implementado.
