...
También existen plataformas web que permiten consultar esta información de manera individual. Un ejemplo es Tunebat \citep{Tunebat}, que permite visualizar un conjunto de características, pero restringe la consulta a una canción a la vez. En la figura~\ref{fig:tunebat_screenshot} se presenta un ejemplo de la plataforma web Tunebat.
