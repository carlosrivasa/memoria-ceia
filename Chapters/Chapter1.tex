...
La extracción de información musical, comúnmente conocida como MIR (por sus siglas en inglés \textit{Music Information Retrieval}), procesa, analiza y organiza datos musicales \citep{Downie2003}.
Los sistemas MIR abarcan el procesamiento digital de señales y el aprendizaje automático, y permiten automatizar tareas como el etiquetado de canciones, la clasificación de géneros o el reconocimiento de estados de ánimo a partir del audio digital \citep{Casey2008}.
...
Esta sección define las metas del proyecto. Se presentan los objetivos generales y específicos, los pasos metodológicos necesarios para su cumplimiento y el conjunto de características musicales consideradas.

\subsection{Objetivo general}

Desarrollar un sistema predictivo basado en inteligencia artificial para la caracterización automática de canciones a partir de su archivo de audio, destinado a dotar de autonomía a la aplicación de la empresa y a reducir la dependencia de servicios de terceros.

\subsection{Objetivos específicos}

Para alcanzar el objetivo general, se definen los siguientes pasos metodológicos:
...
Para cada una de las características mencionadas se aplican los pasos mencionados en los objetivos específicos.
El detalle técnico, las definiciones formales y el modelado de cada característica como problema de clasificación o regresión se abordan en el capítulo de desarrollo.
...
\end{figure}
\footnotetext{Imagen tomada de \url{https://tunebat.com/Info/Weird-Fishes-Arpeggi-Radiohead/4wajJ1o7jWIg62YqpkHC7S}}
% \subsection{Carpetas}


\section{Estructura del documento}

Para exponer de manera ordenada el desarrollo y los resultados del sistema, la presente memoria se estructura en los siguientes capítulos:

En el \textbf{Capítulo 2} se introduce el marco teórico. Se definen los conceptos matemáticos y computacionales sobre los que se sustenta el trabajo, incluyendo el procesamiento de señales de audio y los fundamentos del aprendizaje automático. 

En el \textbf{Capítulo 3} se detalla el desarrollo metodológico. Se documenta la selección del conjunto de datos, el análisis exploratorio y el proceso de extracción de características, así como las arquitecturas de los modelos predictivos utilizados.

En el \textbf{Capítulo 4} se presentan los resultados obtenidos. Se evalúa el desempeño de los distintos modelos entrenados y se justifica la selección final de los algoritmos para su paso a producción.

Finalmente, en el \textbf{Capítulo 5} se exponen las conclusiones generales del proyecto, el cumplimiento de los objetivos propuestos y las posibles líneas de trabajo futuro para escalar el sistema implementado.
